...
const ApplicationForm = () => {
  ...
  const departments = [
    "Accomodation", "App Dev Competition", "Artificial Intelligence Competition",
    "Automation", "Bridge Construction Competition", "CAD War Competition",
    "Ceremonies", "Conferences", "Cyber Security Competition",
    "Data Visualisation Competition", "Decor", "Engineering Project Competition",
    "Evaluations", "FoodCourt", "Game Jam Competition", "Gaming Competition",
    "Graphic Design", "Ideas Xtreme", "Infrastructure", "International Affairs",
    "Invitations", "Logistics", "Marketing", "Media and Promotions", "Office",
    "Partnerships", "Photography", "Programming Competition", "Public Relations",
    "Query Master Competition", "Reception", "Robo Rumble", "Security",
    "Sketching Competition", "Software House Enclosure",
    "Software Project Competition", "UI/UX Competition", "Videography",
