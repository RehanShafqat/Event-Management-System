...
export function DeputyHeadDashboard(){
    ...
    <div className="min-h-screen bg-[#161616]">
      ...
      <div className="ml-64 p-8">
        <header className="flex justify-between items-center mb-8">
          <h2 className="text-2xl font-bold text-white">DeputyHead Dashboard</h2>
                ...
                <DropdownMenuLabel className="font-normal text-gray-300">
                  <div className="flex flex-col space-y-1">
                    <p className="text-sm font-medium leading-none">
                      {user?.name || "DeputyHead"}
                    </p>
                    <p className="text-xs leading-none text-gray-400">
                      {user?.email || "deputy@softec.com"}
                    </p>
                  </div>
                </DropdownMenuLabel>
        ...
        <div className="grid gap-4 lg:grid-cols-3 mb-6">
          <Card className="lg:col-span-2 bg-gray-800 border-gray-700">
            ...
            <CardContent className="space-y-4">
              <ActivityItem
                title="Task Assigned"
                description="You assigned a task to Officer."
                time="3h ago"
